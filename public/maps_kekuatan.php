...
<section id="contact" class="wow">
  <div class="container">
    <div class="section-header">
      <h2>Informasi Jumlah Kejadian Gempa Berdasarkan Kekuatan</h2>
    </div>
  </div>
      ...
      <div class="card" style="width: 100%;">
        <div class="card-header">
          <form class="form-inline pull-right" id="tahunJumlahKejadianForm">
            <input type="hidden" name="hal" value="maps_kekuatan">
...
<script>
  ...
  function cari(){
    var options = {
      ...
      title: {
        text: 'Presentase Kejadian Gempa Berdasarkan Kekuatan'
      },
      tooltip: {
        formatter: function() {
