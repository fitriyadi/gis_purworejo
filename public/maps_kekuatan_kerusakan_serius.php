...
<section id="contact" class="wow fadeInUp">
  <div class="container">
    <div class="section-header">
      <h2>Informasi Jumlah Kejadian Gempa Dengan Kekuatan Kerusakan Serius (> 6 SR)</h2>
      ...
      <div class="card" style="width: 100%;">
        <div class="card-header">
          <form class="form-inline pull-right" id="tahunJumlahKejadianForm">
            <input type="hidden" name="hal" value="maps_kekuatan_kerusakan_serius">
    ...
    <script>
      ...
      function cari(){
        var options = {
          ...
          title: {
            text: 'Presentase Kejadian Gempa Berdasarkan Kekuatan Kerusakan Serius'
          },
          tooltip: {
            formatter: function() {
      ...
      var url = 'grafik_kekuatan_kerusakan_serius.php';
      ...
      $.ajax({
        type    : 'POST',
        url     : '../ajax/maps_kekuatan_kerusakan_serius.php',
