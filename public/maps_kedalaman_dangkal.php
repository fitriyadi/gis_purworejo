...
<section id="contact" class="wow fadeInUp">
  <div class="container">
    <div class="section-header">
      <h2>Informasi Jumlah Kejadian Gempa Dengan Kedalaman Dangkal (< 60 KM)</h2>
      ...
      <div class="card" style="width: 100%;">
        <div class="card-header">
          <form class="form-inline pull-right" id="tahunJumlahKejadianForm">
            <input type="hidden" name="hal" value="maps_kedalaman_dangkal">
    ...
    <script>
      ...
      function cari(){
        var options = {
          ...
          title: {
            text: 'Presentase Kejadian Gempa Berdasarkan Kedalaman Dangkal'
          },
          tooltip: {
            formatter: function() {
      ...
      var url = 'grafik_kedalaman_dangkal.php';
      ...
      $.ajax({
        type    : 'POST',
        url     : '../ajax/maps_kedalaman_dangkal.php',
