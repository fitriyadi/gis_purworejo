...
<section id="contact" class="wow fadeInUp">
  <div class="container">
    <div class="section-header">
      <h2>Informasi Jumlah Kejadian Gempa Dengan Kekuatan Tidak Terasa (< 3 SR)</h2>
      ...
      <div class="card" style="width: 100%;">
        <div class="card-header">
          <form class="form-inline pull-right" id="tahunJumlahKejadianForm">
            <input type="hidden" name="hal" value="maps_kekuatan_tidak_terasa">
    ...
    <script>
      ...
      function cari(){
        var options = {
          ...
          title: {
            text: 'Presentase Kejadian Gempa Berdasarkan Kekuatan Tidak Terasa'
          },
          tooltip: {
            formatter: function() {
      ...
      var url = 'grafik_kekuatan_tidak_terasa.php';
      ...
      $.ajax({
        type    : 'POST',
        url     : '../ajax/maps_kekuatan_tidak_terasa.php',
