...
<section id="contact" class="wow fadeInUp">
  <div class="container">
    <div class="section-header">
      <h2>Informasi Gempa Berdasarkan Jumlah Kejadian</h2>
      ...
      <div class="card" style="width: 100%;">
        <div class="card-header">
          <form class="form-inline pull-right" id="tahunJumlahKejadianForm">
            <input type="hidden" name="hal" value="maps_kejadian">
    ...
    <script>
      ...
      function cari(){
        var options = {
          ...
          title: {
            text: 'Presentase Kejadian Gempa Per-Kabupaten'
          },
          tooltip: {
            formatter: function() {
      ...
      var url = 'grafik_kejadian.php';

      <?php if (isset($_GET['tahun']) && !empty($_GET['tahun'])) {
        $tahun = $_GET['tahun'];
        echo "url = 'grafik_kejadian.php?tahun={$tahun}'";
      } ?>
