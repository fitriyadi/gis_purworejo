...
<section id="contact" class="wow fadeInUp">
  <div class="container">
    <div class="section-header">
      <h2>Informasi Jumlah Kejadian Gempa Berdasarakan Kedalaman</h2>
      ...
      <div class="card" style="width: 100%;">
        <div class="card-header">
          <form class="form-inline pull-right" id="tahunJumlahKejadianForm">
            <input type="hidden" name="hal" value="maps_kedalaman">
          ...
          <div class="card-body">
            ...
            <div class="col-12">
              <div class="panel panel-primary">
                <div class="panel-heading" style="color: white;">Dalam Bentuk Grafik</div>
           ...
           <div class="col-12">
            <div class="panel panel-primary">
              <div class="panel-heading" style="color: white;">Dalam Bentuk Tabel</div>
              <div class="panel-body">
...
<script>
  ...
  function cari(){
    var options = {
      ...
      title: {
        text: 'Presentase Kejadian Gempa Berdasarkan Kedalaman'
      },
      tooltip: {
        formatter: function() {
